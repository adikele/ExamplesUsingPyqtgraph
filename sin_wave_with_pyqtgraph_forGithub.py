# -*- coding: utf-8 -*-
"""
This example demonstrates how a sine wave can be plotted in the framework of pyqtgraph's "Flowcharts: examples" code.
It displays a sine wave.

Basic steps are:
  - create a flowchart and two plots
  - input sine wave to the flowchart
...
ToDo:
1. Seek clarity on how is the sine wave affected when it passes through the Gaussian filter.
"""
...
win.setWindowTitle('Sine wave using pyqtgraph Flowchart')
cw = QtGui.QWidget()
